...
#include <cmath>
#include <iomanip>
#include "../lib/integration/right_rectangle.hpp"

using std::cout, std::endl, std::setw, std::vector;
using nuan::integration::right_rectangle;
...
int main()
{
    ...
    long double solution = right_rectangle(f, a, b, step);
    x = a;

    cout << "Numerical solution of the integral"
            "using right rectangles:" << endl;
    cout.precision(20);
    cout <<
            setw(30) << "| approx_I |" <<
