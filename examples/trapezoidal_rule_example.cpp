...
#include <cmath>
#include <iomanip>
#include "../lib/integration/trapezoidal_rule.hpp"

using std::cout, std::endl, std::setw, std::vector;
using nuan::integration::trapezoidal_rule;
...
int main()
{
    ...
    long double solution = trapezoidal_rule(f, a, b, step);
    x = a;

    cout << "Numerical solution of the integral"
            "using trapezoidal rule:" << endl;
    cout.precision(20);
    cout <<
            setw(30) << "| approx_I |" <<
